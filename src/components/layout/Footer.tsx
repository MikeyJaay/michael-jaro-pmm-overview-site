...
const SocialIcons = () => (
  <>
    ...
    <a
      href="https://github.com/MikeyJaay/michael-jaro-pmm-overview-site"
      target="_blank"
      rel="noopener noreferrer"
      className="flex h-9 w-9 items-center justify-center rounded-lg text-muted-foreground transition-colors hover:bg-primary/10 hover:text-primary"
...
const Footer = () => (
  <footer className="border-t border-border/50 bg-card/50">
    <div className="container mx-auto px-4 py-8">
      ...
      {/* Mobile — "Made with" left, social icons pinned right */}
      ...
      {/* Desktop — "Made with" truly centered, social icons absolute right */}
